...
const HEADER_HEIGHT = dimension.height *.18;
...
export default class AgendaView extends Component {
  ...
  renderReservations() {
    return (
      <ReservationsList
        key={JSON.stringify(this.props.items)+this.props.dashColor}
  ...
  chooseToday(){
    this.calendar.chooseToday(XDate(true))
  }
